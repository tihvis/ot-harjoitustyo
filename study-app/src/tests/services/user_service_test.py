...
class TestUserService(unittest.TestCase):
    ...
    def test_login_with_valid_username_and_invalid_password(self):
        self.assertRaises(InvalidCredentialsError, lambda: user_service.login(self.username, "Test1111"))
    ...
    def test_create_username_with_no_number_in_password(self):
        self.assertRaises(InvalidPasswordError, lambda: user_service.create_user("username", "Nonumber", "Nonumber"))

    def test_create_username_with_not_matching_passwords(self):
        self.assertRaises(PasswordConfirmationError, lambda: user_service.create_user("username", "Test12345", "Test54321"))
