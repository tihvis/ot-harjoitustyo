...
class CourseService:
    ...
    def create_course(self, name, credits, exercises, exercise_group, project, exam, peer_review, feedback, other):
        ...
        if self.values_ok(name, credits, exercises, exercise_group, project, exam, peer_review, feedback, other):
            course = self._course_repository.create(Course(user_id=user_id, name=name, credits=credits, exercises=exercises,
                                                    exercise_group=exercise_group, project=project, exam=exam, peer_review=peer_review, feedback=feedback, other=other))
